(function () {
     ...
     * thì sẽ dùng "caro5".
     *
     * Riêng trang GameHub không có data-game,
     * nên mặc định là "hub".
     * ---------------------------------------------------------
     */
    ...
    async function startPresence() {
        ...
        /*
         * -----------------------------------------------------
         * Mỗi user có đúng 1 presence node.
         *
         * presence/{uid}
         * -----------------------------------------------------
         */
